...
export default function FormBuilderPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-surface">
        <div className="text-center">
          <div className="inline-block animate-spin rounded-full h-6 w-6 border-2 border-[#E5E7EB] border-t-[#7C3AED] mb-3" />
          <p className="text-[#6B7280]">Loading form...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="h-screen bg-surface flex flex-col overflow-hidden">
      {/* Top Bar */}
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-[#E5E7EB]/60 px-4 py-2.5 flex-shrink-0">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            {editingTitle ? (
              ...
              <h1
                className="text-lg font-semibold text-[#111111] truncate cursor-pointer hover:text-[#6B7280] transition-colors"
                onClick={() => {
            ...
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 text-xs text-[#6B7280] hover:text-[#111111] hover:bg-[#FAFAFB] rounded-lg transition-colors"
            >
              <Settings className="w-3.5 h-3.5" />
              <span>Settings</span>
            </button>

            {saving && <span className="text-xs text-[#7C3AED] animate-pulse">Saving...</span>}
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={overflowRef}>
              ...
              {overflowOpen && (
                <div className="absolute right-0 top-full mt-1 w-48 bg-white border border-[#E5E7EB] rounded-xl shadow-soft-lg py-1 z-50">
                  {status === 'live' && slug && (
                    <button onClick={copyPublicUrl} className="w-full text-left px-4 py-2 text-sm text-[#6B7280] hover:bg-[#FAFAFB] flex items-center gap-2">
                      <Copy className="w-4 h-4" /> Copy public URL
                    </button>
                  )}
                  <button
                    onClick={() => { router.push(`/dashboard/forms/${formId}/results`); setOverflowOpen(false); }}
                    className="w-full text-left px-4 py-2 text-sm text-[#6B7280] hover:bg-[#FAFAFB] flex items-center gap-2"
                  >
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Builder Panel (Left) */}
        <div className="w-[440px] flex-shrink-0 border-r border-[#E5E7EB]/60 bg-white flex flex-col">
          ...
          <div className="flex border-b border-[#E5E7EB] flex-shrink-0">
            ...
            >
              Editor
              {activeTab === 'editor' && (
                <span className="absolute bottom-0 left-4 right-4 h-0.5 bg-[#7C3AED] rounded-full" />
              )}
            </button>
            <button
            ...
            <div className="divide-y divide-[#E5E7EB]/60">
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-[#FAFAFB] transition-colors"
                >
                  <span className="w-6 h-6 rounded-full bg-[#7C3AED] text-white text-xs font-semibold flex items-center justify-center flex-shrink-0">1</span>
                  <span className="text-[13px] font-semibold text-[#111111] flex-1 text-left">Overview</span>
                  <ChevronRight className={`w-4 h-4 text-[#6B7280]/40 transition-transform duration-200 ${openSections.has(1) ? 'rotate-90' : ''}`} />
                </button>
                {openSections.has(1) && (
                  <div className="px-5 pb-5 pt-1 pl-14 space-y-4">
                    <div>
                      <label className="text-[11px] font-medium text-[#6B7280] uppercase tracking-wider mb-1 block">What is this conversation about?</label>
                      <p className="text-[11px] text-[#6B7280]/60 mb-1.5">Describe the purpose and AI will build your form</p>
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-[#FAFAFB] transition-colors"
                >
                  <span className="w-6 h-6 rounded-full bg-[#7C3AED] text-white text-xs font-semibold flex items-center justify-center flex-shrink-0">2</span>
                  <span className="text-[13px] font-semibold text-[#111111] flex-1 text-left">Tone of voice</span>
                  <ChevronRight className={`w-4 h-4 text-[#6B7280]/40 transition-transform duration-200 ${openSections.has(2) ? 'rotate-90' : ''}`} />
                </button>
                {openSections.has(2) && (
                  <div className="px-5 pb-5 pt-1 pl-14 space-y-4">
                    <div>
                      <label className="text-[11px] font-medium text-[#6B7280] uppercase tracking-wider mb-1.5 block">Custom tone</label>
                      <Input
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <label className="text-[11px] font-medium text-[#6B7280] uppercase tracking-wider">Tone presets</label>
                        <button
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <label className="text-[11px] font-medium text-[#6B7280] uppercase tracking-wider">Chattiness level</label>
                    ...
                    <div>
                      <label className="text-[11px] font-medium text-[#6B7280] uppercase tracking-wider mb-1.5 block">Audience</label>
                      <Input
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-[#FAFAFB] transition-colors"
                >
                  <span className="w-6 h-6 rounded-full bg-[#7C3AED] text-white text-xs font-semibold flex items-center justify-center flex-shrink-0">3</span>
                  <span className="text-[13px] font-semibold text-[#111111] flex-1 text-left">Welcome & End screens</span>
                  <ChevronRight className={`w-4 h-4 text-[#6B7280]/40 transition-transform duration-200 ${openSections.has(3) ? 'rotate-90' : ''}`} />
                </button>
                {openSections.has(3) && (
                  <div className="px-5 pb-5 pt-1 pl-14 space-y-5">
                    <div className="space-y-3" onClick={() => setPreviewTarget('welcome')}>
                      <div className="flex items-center justify-between">
                        <label className="text-[11px] font-medium text-[#6B7280] uppercase tracking-wider">Welcome screen</label>
                        <Switch
                    ...
                    <div className="border-t border-slate-100 pt-4 space-y-3" onClick={() => setPreviewTarget('end')}>
                      <div className="flex items-center justify-between">
                        <label className="text-[11px] font-medium text-[#6B7280] uppercase tracking-wider">End screen</label>
                        <Switch
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-[#FAFAFB] transition-colors"
                >
                  <span className="w-6 h-6 rounded-full bg-[#7C3AED] text-white text-xs font-semibold flex items-center justify-center flex-shrink-0">4</span>
                  <span className="text-[13px] font-semibold text-[#111111] flex-1 text-left">
                    Journey
                    {currentConfig.questions.length > 0 && (
                      <span className="text-slate-400 font-normal ml-1">({currentConfig.questions.length})</span>
                    )}
                  </span>
                  <ChevronRight className={`w-4 h-4 text-[#6B7280]/40 transition-transform duration-200 ${openSections.has(4) ? 'rotate-90' : ''}`} />
                </button>
                {openSections.has(4) && (
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-[#FAFAFB] transition-colors"
                >
                  <span className="w-6 h-6 rounded-full bg-[#7C3AED] text-white text-xs font-semibold flex items-center justify-center flex-shrink-0">5</span>
                  <span className="text-[13px] font-semibold text-[#111111] flex-1 text-left">Visuals</span>
                  <ChevronRight className={`w-4 h-4 text-[#6B7280]/40 transition-transform duration-200 ${openSections.has(5) ? 'rotate-90' : ''}`} />
                </button>
                {openSections.has(5) && (
                  <div className="px-5 pb-5 pt-1 pl-14 space-y-5">
                    <StepVisualManager
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-5 py-3.5 hover:bg-[#FAFAFB] transition-colors"
                >
                  <span className="w-6 h-6 rounded-full bg-[#7C3AED] text-white text-xs font-semibold flex items-center justify-center flex-shrink-0">6</span>
                  <span className="text-[13px] font-semibold text-[#111111] flex-1 text-left">About you</span>
                  <ChevronRight className={`w-4 h-4 text-[#6B7280]/40 transition-transform duration-200 ${openSections.has(6) ? 'rotate-90' : ''}`} />
                </button>
                {openSections.has(6) && (
                  <div className="px-5 pb-5 pt-1 pl-14">
                    <label className="text-[11px] font-medium text-[#6B7280] uppercase tracking-wider mb-1.5 block">Brand / company</label>
                    <Textarea
              ...
              <div>
                ...
                >
                  ...
                  <span className="text-[13px] font-semibold text-[#111111] flex-1 text-left">Train AI</span>
                  <span className="text-[10px] text-slate-400 bg-slate-100 px-1.5 py-0.5 rounded-full mr-1">Optional</span>
                  <ChevronRight className={`w-4 h-4 text-[#6B7280]/40 transition-transform duration-200 ${openSections.has(7) ? 'rotate-90' : ''}`} />
                </button>
                {openSections.has(7) && (
                  <div className="px-5 pb-5 pt-1 pl-14">
        ...
        return (
          <div key={row.id}>
            ...
            >
              ...
              <ChevronRight className={`w-3.5 h-3.5 text-[#6B7280]/40 transition-transform ${isExpanded ? 'rotate-90' : ''}`} />
            </button>
            {isExpanded && (
